...
<body>
    ...
    <main>
        ...
        <h2>Nike</h2>
        <section id = "product">
          <img id = "product-img" src="https://picsum.photos/200/300">
          <article id = "product-description">
              <h2>Nike Air Zoom Pegasus 38</h2> <br>
              <p>A Nike Air Zoom Pegasus 38 é uma sapatilha versátil e confortável, perfeita para corridas de longa distância e treinos diários. Ela apresenta uma entressola responsiva com unidade Zoom Air no calcanhar, proporcionando amortecimento eficaz e retorno de energia. O cabedal em mesh respirável oferece ventilação e suporte, enquanto a sola de borracha durável proporciona tração em uma variedade de superfícies. Disponível em diversos tamanhos e cores.</p> <br>
